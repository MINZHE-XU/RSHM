...
class DroneContainer extends React.Component {
    ...
    return (
      ...
      <Marker position={{ lat: spot.lat, lng: spot.lng}}
        ...
        icon={
          ...
          {url: heliport_marker,scaledSize:new google.maps.Size(50, 50),anchor: new google.maps.Point(25, 25)}:
          (spot.lat===this.props.statusPoint.center.lat && spot.lng===this.props.statusPoint.center.lng)?
          {url: heliport_marker ,scaledSize:new google.maps.Size(40, 40),anchor: new google.maps.Point(20, 20)}:
          {url: heliport_marker ,scaledSize:new google.maps.Size(30, 30),anchor: new google.maps.Point(15, 15)}}
  ...
  handleOnMouseOver= (spot, e) => {
    this.props.centerListSpot ({...spot, kind:"drone"})
  }

  handleOnClick= (spot,e) => {
    this.props.clickListSpot ({...spot, kind:"drone"})
  }
}
